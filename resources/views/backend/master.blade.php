                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="javascript: void(0);"><i class="fi-layers"></i> <span> Question </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ url('/add-que') }}">ADD</a></li>
                                    <li><a href="{{ url('/view-que') }}">View</a></li>
                                   
                                </ul>
                            </li>
                            <li>
                                <a href="javascript: void(0);"><i class="fi-layers"></i> <span> Result </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                  
                                    <li><a href="{{ route('UserResult')}}">View</a></li>
                                    <li><a href="{{ route('ViewDetailsRe')}}"</a></li>
                                    

                                </ul>
                            </li>
                             <li>
                                <a target="blank" href="{{ route('frontpage')}}">
                                    <i class="fi-globe"></i><span class="badge badge-danger badge-pill float-right"></span> <span> Visit Home </span>
                                </a>
                            </li>
                        ...
                        <ul class="list-unstyled topbar-right-menu float-right mb-0">
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" role="button"
                                   aria-haspopup="false" aria-expanded="false">
                                    <img src="{{ url('/backend')  }}//images/users/avatar-1.jpg" alt="user" class="rounded-circle"> <span class="ml-1">{{ Auth::user()->name }} <i class="mdi mdi-chevron-down"></i> </span>
                                </a>
